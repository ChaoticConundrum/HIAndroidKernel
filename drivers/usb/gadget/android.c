...
static struct hidg_func_descriptor hid_nkey_keyboard_desc = {
    .subclass           = 0, // Default subclass
    .protocol           = 1, // Keyboard
    .report_length      = 30,
    .report_desc_length = 31,
    .report_desc = {
...
static int hid_function_bind_config(struct android_usb_function *func, struct usb_configuration *config){
    ...
    return hidg_bind_config(config, &hid_nkey_keyboard_desc, 1);
}
